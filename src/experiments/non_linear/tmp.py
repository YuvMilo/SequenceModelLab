...
from src.training.train_ssm import train_ssm
...
if __name__ == "__main__":
    ...
    #     training_dict={'lr': '0.0001', 'noise': '0.001',
    ...
    #     epochs=300,
    #     seq_len=300,
    #     progress_bar_actor=None,
    #     save_dir=os.path.join("..", "results", "delete"),
    #     device="cpu",
    #     training_uuid=1234,
    #     log_param_every=100,
    #     samples_num=64
    ...
    get_hippo_training_task(
        training_dict={'lr': '0.0001', 'dt': '0.1',
    ...
    #     training_dict={'rot_type': 'eq', 'lr': '0.0001',
