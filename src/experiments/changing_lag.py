...
from src.experiments.utils.best_settings import top_hippo_res, \
    top_rot_res, top_hippo_no_res, top_fssm_res
from src.experiments.utils.get_standard_tasks import get_ssm_training_task, \
    get_hippo_training_task, get_hippo_no_training_task, get_rot_training_task

device = torch.device('cuda' if torch.cuda.is_available() else 'cpu')

log_param_every = 8
save_dir = os.path.join("..", "results", "changing_lag")
